...
config.TRAIN.hr_lir_path = 'data2017/DIV2K_train_IR_HR/'
config.TRAIN.lr_img_path = 'data2017/DIV2K_train_LR_bicubic/X4/'

config.VALID = edict()
## test set location
config.VALID.hr_img_path = 'data2017/DIV2K_train_HR/'
config.VALID.hr_lir_path = 'data2017/DIV2K_train_IR_HR/'
config.VALID.lr_img_path = 'data2017/DIV2K_valid_LR_bicubic/X4/'
config.VALID.lr_lir_path = 'data2017/DIV2K_valid_IR_LR/'
